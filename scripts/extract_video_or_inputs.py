...
run_dir = base_dir / "save" / "322_2" / "best_runs"
...
for a in run_dir.iterdir():
    ...
    shutil.copyfile(run_dir / time_ms / "actions.txt", out_dir / f"{time_ms}.inputs")


# run_to_video.make_widget_video_from_q_values_on_disk(
#     q_values_path=run_dir / "55360" / "q_values.joblib", video_path=base_dir / "55360.mov", q_value_gap=0.03
# )
