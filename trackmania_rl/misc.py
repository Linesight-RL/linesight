...
map_cycle += [
    ...
    # repeat(("yosh3", '"My Challenges\Yosh3.Challenge.Gbx"', "yosh3_0.5m_clprog_cut1.npy", False, True, True), 1),
...
cropped_size = (H_downsized - 2 * n_pixels_to_crop_on_each_side, W_downsized - 2 * n_pixels_to_crop_on_each_side)
